    ...
    def __init__(self, dataset):
        ...
        for i in range(self.dataset.n_job):
            for j in range(self.dataset.n_machine):
                self.op_list[i].append(Operation(i, j, self.machine_list[op_data[i][j][0]], dataset.n_machine))
